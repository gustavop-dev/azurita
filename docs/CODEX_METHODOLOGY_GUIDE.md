...
Azurita uses a **Codex-native repo runtime**. Claude Code is maintained as a compatibility layer only — they must stay aligned with the Codex-native source of truth, not redefine it.

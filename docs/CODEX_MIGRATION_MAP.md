...
Azurita migrated from the **Codex plugin/marketplace model** to the **native repo skills model**. The native model is the correct Codex approach: skills live in the repo itself and require no external plugin registry.
...
| `plugins/azurita-codex/.codex-plugin/plugin.json` | removed |
| `plugins/azurita-codex/skills/<skill>/SKILL.md` | `.agents/skills/<skill>/SKILL.md` |
...
| Before | After |
|--------|-------|
| `plugins/azurita-codex/skills/` | `.agents/skills/` |
| `plugins/azurita-codex/.codex-plugin/` | `.codex/` |
...
| verbose generic SKILL.md content | Azurita-specific, concise SKILL.md content |
...
|--------|-------|
| `plugins/azurita-codex/skills/*` | `.agents/skills/*` |
| `Plugin manifest: plugins/azurita-codex/.codex-plugin/plugin.json` | `Project config: .codex/config.toml` |

...
onMounted(() => {
  puzzleCompleted.value = localStorage.getItem('puzzle_3_solved') === 'true'
})
    ...
    <div class="bg-white rounded-3xl w-full max-w-xl border-4 border-black" style="box-shadow: 10px 10px 0px 0px rgba(244, 162, 97, 0.3);">
      ...
      <div v-if="!puzzleCompleted">
        ...
        <div class="text-center pt-10 pb-8 px-10">
          <span class="text-xs uppercase tracking-widest text-gray-400 font-medium">Día 3</span>
        </div>
        
        <!-- Pregunta -->
        <div class="px-10 pb-10 text-center">
          <p class="text-3xl font-black text-gray-800 leading-relaxed">
            Yo me enamoré de ti por un...
          </p>
        ...
        <!-- Form -->
        <div class="p-10">
          <label class="block text-sm font-semibold text-gray-500 mb-4">Completa la frase</label>
